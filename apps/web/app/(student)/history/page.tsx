const mockHistory = [
  ...
  { id: "2", persona: "Dr. Newton", subject: "Physics", topic: "Newton's Laws", duration: "18 min", score: 72, date: "Yesterday, 4:15 PM" },
    ...
    <div>
      ...
      <div className="space-y-4">
        {mockHistory.map((session) => (
          <div key={session.id} className="rounded-xl border border-white/10 bg-white/5 p-6 hover:border-white/20 transition">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-600/20">
                  <span className="text-sm font-bold text-blue-400">{session.persona.charAt(0)}</span>
                </div>
                <div>
